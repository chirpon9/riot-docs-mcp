...
## Endpoint: GET /val/match/v1/matches/{matchId}
...
## Endpoint: GET /val/match/v1/matchlists/by-puuid/{puuid}
...
## Endpoint: GET /val/match/v1/recent-matches/by-queue/{queue}
...
### Path Parameters
- **queue** (required, string): Legal values: competitive, unrated, spikerush, tournamentmode, deathmatch, onefa, ggteam, hurm, swiftplay
